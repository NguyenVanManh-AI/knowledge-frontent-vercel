<template>
  <div id="header">
    <div class="title">
      <span> <i class="fa-solid fa-graduation-cap"></i> Knowledge</span><span>/</span><span v-html="title"></span>
    </div>
    <div id="contact">
      ...
      <div class="email-phone">
        <li class="contact_email"><a href="mailto:Knowledge.support@gmail.com"><i class="fa-solid fa-envelope"></i> <span
              class="hidde">Email:</span>
            <span> Knowledge.support@gmail.com</span></a></li>
