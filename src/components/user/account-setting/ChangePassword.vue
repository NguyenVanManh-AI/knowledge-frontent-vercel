        ...
        <div id="big">
            <div class="bigContainer">
                <button data-toggle="modal" data-target="#exampleModalChangePassword" id="openChangePassword" type="button"
                    class="mt-4 btn-pers"><i class="fa-solid fa-gear"></i> Thay đổi</button>
                            ...
                            <div class="modal-body">
                                <form @submit.prevent="changePassword()">
                                    <div class="input-form">
                                        ...
                                        <div class="underline"></div><label><i class="fa-solid fa-lock"></i> Mật khẩu hiện tại</label>
                                    </div>
                                    ...
                                    <div class="input-form">
                                        ...
                                        <div class="underline"></div><label><i class="fa-solid fa-lock"></i> Mật khẩu mới</label>
                                    </div>
                                    ...
                                    <div class="input-form">
                                        ...
                                        <div class="underline"></div><label><i class="fa-solid fa-lock"></i> Xác nhận Mật khẩu mới </label>
                                    </div>
                                    <span v-if="errors.confirm_password" class="text-danger">{{
                                        errors.confirm_password[0] }}<br></span>
                                    <br>
...
export default {
    ...
    methods: {
        changePassword: async function () {
            try {
                const { messages } = await UserRequest.post('change-password', this.newPassword, true);
